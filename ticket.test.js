...
test("Negative test: Button should be disabled when seats cannot be selected", async () => {
  ...
  await clickElement(
    page,
    "body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(5) > span.buying-scheme__chair.buying-scheme__chair_standart.buying-scheme__chair_taken",
    { force: true }
  );
